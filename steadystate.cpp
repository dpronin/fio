...
static void steadystate_alloc(struct thread_data *td)
{
	...
	td->ss.bw_data = static_cast<uint64_t*>(calloc(intervals, sizeof(uint64_t)));
	td->ss.iops_data = static_cast<uint64_t*>(calloc(intervals, sizeof(uint64_t)));
