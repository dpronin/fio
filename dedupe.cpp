 ...
 */
int init_global_dedupe_working_set_seeds()
{
	for_each_td(td) {
...
int init_dedupe_working_set_seeds(struct thread_data *td, bool global_dedup)
{
	...
	td->dedupe_working_set_states = static_cast<struct frand_state*>(malloc(sizeof(struct frand_state) * td->num_unique_pages));
