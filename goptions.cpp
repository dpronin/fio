				      ...
				      gboolean visible)
{
	...
	while (child) {
		struct fio_option *o = static_cast<struct fio_option *>(child->data);
		struct gopt *g = static_cast<struct gopt *>(o->gui_data);
				       ...
				       unsigned int idx)
{
	...
	s = static_cast<struct gopt_str *>(calloc(1, sizeof(*s)));
					   ...
					   unsigned int idx, int type)
{
	...
	c = static_cast<struct gopt_combo *>(calloc(1, sizeof(*c)));
				       ...
				       struct fio_option *o, unsigned int idx)
{
	...
	m = static_cast<struct gopt_str_multi *>(calloc(1, sizeof(*m)));
...
static void gopt_int_changed(GtkSpinButton *spin, gpointer data)
{
	...
	if (o->inv_opt) {
		struct gopt *b_inv = static_cast<struct gopt *>(o->inv_opt->gui_data);
				       ...
				       unsigned long long *p, unsigned int idx)
{
	...
	i = static_cast<struct gopt_int *>(calloc(1, sizeof(*i)));
...
static void gopt_bool_toggled(GtkToggleButton *button, gpointer data)
{
	...
	if (o->inv_opt) {
		struct gopt *g_inv = static_cast<struct gopt *>(o->inv_opt->gui_data);
				  ...
				  unsigned int idx)
{
	...
	b = static_cast<struct gopt_bool *>(calloc(1, sizeof(*b)));
				       ...
				       unsigned int idx)
{
	...
	r = static_cast<struct gopt_range *>(calloc(1, sizeof(*r)));
				     ...
				     unsigned long long *p, unsigned int idx)
{
	...
	g = static_cast<struct gopt_str_val *>(calloc(1, sizeof(*g)));
			    ...
			    struct gopt *gopt, struct thread_options *to)
{
	...
	case FIO_OPT_STR_VAL: {
		...
		if (o->off1)
			ullp = static_cast<unsigned long long *>(td_var(to, o, o->off1));
	...
	case FIO_OPT_INT:
		if (o->posval[0].ival) {
			...
			if (o->off1)
				ip = static_cast<unsigned int *>(td_var(to, o, o->off1));
	...
	case FIO_OPT_STR: {
		if (o->posval[0].ival) {
			...
			if (o->off1) {
				char **p = static_cast<char **>(td_var(to, o, o->off1));
	...
	case FIO_OPT_RANGE: {
		struct gopt_range *r;
		unsigned int *ip[4] = { static_cast<unsigned int *>(td_var(to, o, o->off1)),
					static_cast<unsigned int *>(td_var(to, o, o->off2)),
					static_cast<unsigned int *>(td_var(to, o, o->off3)),
					static_cast<unsigned int *>(td_var(to, o, o->off4))
		};
...
static void gopt_handle_str_multi_changed(struct gopt_job_view *gjv,
					  ...
					  struct fio_option *o)
{
	unsigned int *ip = static_cast<unsigned int *>(td_var(gjv->o, o, o->off1));
	struct value_pair *vp;
	gboolean set;
	guint val = 0;
	int i;
...
static void gopt_handle_range_changed(struct gopt_job_view *gjv,
				      ...
				      struct fio_option *o)
{
	unsigned int *ip[4] = { static_cast<unsigned int *>(td_var(gjv->o, o, o->off1)),
				static_cast<unsigned int *>(td_var(gjv->o, o, o->off2)),
				static_cast<unsigned int *>(td_var(gjv->o, o, o->off3)),
				static_cast<unsigned int *>(td_var(gjv->o, o, o->off4))
	};
	gint val;
	int i;
...
static void gopt_handle_str_val_changed(struct gopt_job_view *gjv,
					...
					struct fio_option *o)
{
	unsigned long long *ullp = static_cast<unsigned long long *>(td_var(gjv->o, o, o->off1));
	GtkAdjustment *adj;
	gint index;
...
{
	char **p = static_cast<char **>(td_var(gjv->o, o, o->off1));
...
void gopt_get_options_window(GtkWidget *window, struct gfio_client *gc)
{
	...
	gjv = static_cast<struct gopt_job_view *>(calloc(1, sizeof(*gjv)));
