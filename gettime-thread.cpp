...
void fio_gtod_init()
{
	...
	fio_ts = static_cast<decltype(fio_ts)>(smalloc(sizeof(*fio_ts)));
}

static void fio_gtod_update()
{
	struct timeval __tv;
...
{
	struct fio_sem *sem = static_cast<struct fio_sem *>(data);
	int ret;
